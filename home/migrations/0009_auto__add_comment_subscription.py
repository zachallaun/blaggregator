...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Comment_Subscription'
        db.create_table(u'home_comment_subscription', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('post', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['home.Post'])),
            ('date', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal(u'home', ['Comment_Subscription'])


    def backwards(self, orm):
        # Deleting model 'Comment_Subscription'
        db.delete_table(u'home_comment_subscription')
    ...
    models = {
        ...
        u'home.comment': {
            ...
            'slug': ('django.db.models.fields.CharField', [], {'default': "'sQABjq'", 'unique': 'True', 'max_length': '6'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"})
        },
        u'home.comment_subscription': {
            'Meta': {'object_name': 'Comment_Subscription'},
        ...
        u'home.post': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'slug': ('django.db.models.fields.CharField', [], {'default': "'yeDErI'", 'unique': 'True', 'max_length': '6'}),
